...
const skills = [
  { id: "ui", name: "UI / Visual Design", x: 250, y: 360, desc: "Crafting intuitive, beautiful, and user-centric interfaces. Focusing on typography, spacing, and modern design patterns.", labelPos: "bottom" },
  { id: "react", name: "React · Next.js", x: 420, y: 280, desc: "Building scalable web applications with modern React frameworks, Server Components, and optimized rendering.", labelPos: "bottom" },
  { id: "motion", name: "Motion · anime.js", x: 450, y: 188, desc: "Adding life to interfaces through fluid, performant animations and micro-interactions.", labelPos: "top" },
  { id: "illust", name: "Illustration", x: 650, y: 100, desc: "Creating unique digital art, vector illustrations, and custom visual assets.", labelPos: "top" },
  { id: "swift", name: "SwiftUI · iOS", x: 725, y: 130, desc: "Developing native, beautifully fluid iOS applications with Swift and SwiftUI.", labelPos: "bottom" },
];
    ...
    <section id="skills" className="relative py-24 px-4 sm:px-8 overflow-hidden">
        ...
        >
          ...
          {skills.map((skill) => (
            ...
            >
              ...
              <div 
                className={`petal-label absolute w-max text-center pointer-events-none opacity-0 ${
                  skill.labelPos === "top" ? "bottom-full mb-2 sm:mb-3" : "top-full mt-2 sm:mt-3"
                }`}
              >
      ...
      <div 
        className={`fixed inset-0 z-50 flex items-center justify-center p-4 transition-all duration-500 ${
          selectedSkill ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'
        }`}
      >
         <div 
         ...
         />
         <div 
           className={`relative w-full max-w-sm glass p-8 rounded-[2rem] shadow-card transform transition-all duration-500 ${
             selectedSkill ? 'scale-100 translate-y-0' : 'scale-95 translate-y-8'
           }`}
         >
            <button 
              onClick={closePopup} 
